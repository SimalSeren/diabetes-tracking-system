...
CREATE TABLE `belirtiler` (
  `belirti_id` int NOT NULL AUTO_INCREMENT,
  `hasta_id` int NOT NULL,
  `belirti_turu` varchar(100) COLLATE utf8mb4_turkish_ci NOT NULL,
  `tarih` datetime NOT NULL,
  PRIMARY KEY (`belirti_id`),
  KEY `hasta_id` (`hasta_id`),
  CONSTRAINT `belirtiler_ibfk_1` FOREIGN KEY (`hasta_id`) REFERENCES `kullanicilar` (`kullanici_id`)
...
INSERT INTO `belirtiler` VALUES (1,2,'Yorgunluk','2025-05-26 07:00:00'),(2,5,'Polidipsi','2025-05-26 07:00:00'),(3,6,'Nöropati','2025-05-26 12:00:00'),(4,7,'Bulanık Görme','2025-05-26 08:00:00'),(5,2,'Baş Ağrısı','2025-05-26 23:03:11'),(6,2,'Polidipsi','2025-05-26 23:03:11');
